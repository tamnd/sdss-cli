...
// HTTP behaviour is covered in sdss_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "sdss://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("sdss", "about")
	if err != nil || got.String() != "sdss://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want sdss://page/about", got.String(), err)
	}
}
