...
Most of these come down to network reality or how sdss serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

sdss rate-limits like any public site. sdss already paces
...
Where a surface is gated, sdss reads a cookie or token you supply
...
`sdss`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what sdss actually did
